...
if authentication_status == True:
    ...
    def main():
        ...
        with col2:
            ...
            st.markdown("[![GitHub](https://img.shields.io/badge/GitHub-View%20on%20GitHub-blue?logo=GitHub)](https://github.com/Abessolo-26/Churn_Prediction_App)")

            # Social Handles Section
            st.header("Social Handles")
            st.write("Connect with me on social media:")
            st.write("- [GitHub](https://github.com/Abessolo-26) 🐙")
            st.write("- [Google Site](https://sites.google.com/view/abessolo-portfolio/accueil) 🐙")
            st.write("- [LinkedIn](https://www.linkedin.com/in/abessolo-ateba-abhas) 💼")
